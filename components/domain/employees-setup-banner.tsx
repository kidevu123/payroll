  ...
  return (
    <div className="rounded-card border border-warning-200 bg-warning-50 p-4">
      <div className="flex items-start gap-3">
        <UserPlus
          className="h-5 w-5 shrink-0 text-warning-700 mt-0.5"
          aria-hidden
        />
        <div className="space-y-2 min-w-0 flex-1">
          ...
          <ul className="text-sm text-warning-900 space-y-1.5">
            {visible.slice(0, 6).map((e) => (
              ...
              >
                <Link
                  ...
                  className="underline underline-offset-2 hover:text-warning-800 min-w-0 truncate"
                >
                  {e.displayName}
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="h-7 shrink-0 text-warning-900 hover:text-warning-900 hover:bg-warning-100/80"
