...
const STATIC_NAV_SEEDS: NavSeed[] = [
  ...
  // Salaried staff live on /payroll's Salaried tab; keep the palette entry
  // so typing "salaried" still lands there.
  { id: "nav-salaried", href: "/payroll?schedule=salaried", labelKey: "salaried" },
  ...
  { id: "nav-cash-drawer", href: "/cash-drawer", labelKey: "cashDrawer" },
  { id: "nav-notifications", href: "/notifications", labelKey: "notifications" },
...
const NAV_ICON_BY_HREF: Record<string, LucideIcon> = {
  ...
  "/time": CalendarDays,
  "/payroll": Wallet,
  "/payroll?schedule=salaried": Briefcase,
