...
export function RunActions({
  ...
  if (state === "PUBLISHED") {
    return (
      <div className="rounded-[--radius-card] border-2 border-emerald-200 bg-emerald-50/40 p-4 flex items-center gap-3">
  ...
  if (state === "AWAITING_ADMIN_REVIEW") {
    return (
      <div className="space-y-3 rounded-[--radius-card] border-2 border-[--color-brand-700] bg-[--surface] p-5">
        {!confirming ? (
          <>
  ...
  if (state === "AWAITING_EMPLOYEE_FIXES") {
    return (
      <div className="rounded-[--radius-card] border border-amber-200 bg-amber-50/40 p-4 flex items-center justify-between gap-3">
  ...
  if (state === "INGEST_FAILED" || state === "FAILED") {
    return (
      <div className="rounded-[--radius-card] border-2 border-red-200 bg-red-50/40 p-4 flex items-center justify-between gap-3">
