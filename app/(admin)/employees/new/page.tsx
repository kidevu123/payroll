  ...
  if (!kind) {
    return (
      <div className="mx-auto max-w-3xl space-y-6">
        <div>
          <h1 className="text-title font-semibold tracking-tight">Add a person</h1>
    ...
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        <div>
          ...
          <h1 className="mt-2 text-title font-semibold tracking-tight">Add a login-only person</h1>
          <p className="text-sm text-text-muted">
