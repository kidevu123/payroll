...
export default async function DashboardPage() {
  ...
  return (
    ...
    <div className="space-y-2.5">
      ...
      <section className="grid items-stretch gap-2.5 md:grid-cols-2 xl:grid-cols-3">
      ...
      <section className="grid items-stretch gap-2.5 lg:grid-cols-12">
      ...
      <section className="grid items-stretch gap-2.5 lg:grid-cols-3">
